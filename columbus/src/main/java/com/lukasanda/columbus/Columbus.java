...
public class Columbus {
    ...
    private Columbus(Context context) {
    ...
    public LocationRequest load(LocationCallback locationListener) {
        return new LocationRequest(singleton.context,locationListener);
    }

    public LocationRequest load() {
        return new LocationRequest(singleton.context, null);
    }
...
//import static com.lukasanda.columbus.Action.RequestWeakReference;
//import static com.lukasanda.columbus.Dispatcher.HUNTER_BATCH_COMPLETE;
//import static com.lukasanda.columbus.Dispatcher.REQUEST_BATCH_RESUME;
//import static com.lukasanda.columbus.Dispatcher.REQUEST_GCED;
//import static com.lukasanda.columbus.Columbus.LoadedFrom.MEMORY;
//
///**
...
//public class Columbus {
//
//  /** Callbacks for Columbus events. */
//  public interface Listener {
//    /**
//     * Invoked when an image has failed to load. This is useful for reporting image failures to a
//     * remote analytics service, for example.
//     */
//    void onImageLoadFailed(Columbus columbus, Uri uri, Exception exception);
//  }
//
//  /**
...
//  }
//
//  static final String TAG = "Columbus";
...
//            hunter.columbus.complete(hunter);
//          }
//          break;
//        }
//        case REQUEST_GCED: {
//          Action action = (Action) msg.obj;
//          if (action.getcolumbus().loggingEnabled) {
//            Utils.log(Utils.OWNER_MAIN, Utils.VERB_CANCELED, action.request.logId(), "target got garbage collected");
//          }
//          action.columbus.cancelExistingRequest(action.getTarget());
//          break;
//        }
...
//            action.columbus.resumeAction(action);
//          }
//          break;
//        default:
...
//  };
//
//  static volatile Columbus singleton = null;
//
...
//  boolean shutdown;
//
//  Columbus(Context context, Dispatcher dispatcher, Cache cache, Listener listener,
...
//   * be used for debugging Columbus behavior. Do NOT pass {@code BuildConfig.DEBUG}.
//   */
...
//
//  /**
//   * The global {@link Columbus} instance.
//   * <p>
...
//   * with full control over the configuration by using {@link Columbus.Builder} to create a
//   * {@link Columbus} instance. You can either use this directly or by setting it as the global
...
//   */
//  public static void setSingletonInstance(@NonNull Columbus columbus) {
//    if (columbus == null) {
//      throw new IllegalArgumentException("Columbus must not be null.");
//    }
//    synchronized (Columbus.class) {
//      if (singleton != null) {
...
//  }
//
//  /** Fluent API for creating {@link Columbus} instances. */
//  @SuppressWarnings("UnusedDeclaration") // Public API.
...
//
//    /** Start building a new {@link Columbus} instance. */
...
//     * <p>
//     * Note: Calling {@link Columbus#shutdown() shutdown()} will not shutdown supplied executors.
//     */
...
//    }
//
//    /** Create the {@link Columbus} instance. */
//    public Columbus build() {
...
//      }
//      if (service == null) {
//        service = new columbusExecutorService();
//      }
//      if (transformer == null) {
...
//
//      return new Columbus(context, dispatcher, cache, listener, transformer, requestHandlers, stats,
